...
models = [RandomForestClassifier(), GradientBoostingClassifier(), HistGradientBoostingClassifier(), ExtraTreesClassifier()]
names = ["RandomForestClassifier", "GradientBoostingClassifier", "HistGradientBoostingClassifier", "ExtraTreesClassifier"]
for model, name in zip(models, names):
    ...
    with open("report_"+name+".pickle", "wb+") as f:
